...
...
SERVER_URL = 'https://your-application-name-development.username.now.sh'
...
```
...
...
GATSBY_SERVER_URL = "https://your-application-name-development.username.now.sh"
...
```
...
...
REACT_APP_SERVER_URL = "https://your-application-name-development.username.now.sh"
...
```
...
- [Create S3 bucket](https://s3.console.aws.amazon.com/s3/) with next **Block public access** settings:
