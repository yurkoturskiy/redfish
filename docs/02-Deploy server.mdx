# Step 2. Set up production build
## Prerequisites:
* Setup local development environment. Otherwise go to Step 1.
* Have accounts on GitHub, [ZEIT](https://zeit.co/) and [AWS](https://aws.amazon.com/).
...
* Add `production` remote to your local development environment and make sure you have both `origin` and `production` remotes:
```console
